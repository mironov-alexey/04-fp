...
namespace TagsCloudGenerator
{
    ...
    {
        public static Color GetRandomColor(Color[] colors, Random random) =>
            ...
            Func<Settings, Statistic, Word, Font> fontGenerator)
        {
            ...
            foreach (var word in statistic.WordsWithFrequency)
            {
                ...
                var color = GetRandomColor(settings.Colors, rand);
        ...
        public static SizeF GetTagSize(Word word, Font font)
        {
